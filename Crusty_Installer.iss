...
Source: "C:\Users\alexc\source\repos\Crusty Media Player\Crusty Media Player\dist\Crusty_Media_Player v1.4.1\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
