...
Source: "C:\Users\alexc\source\repos\Crusty Media Player\Crusty Media Player\dist\Crusty_Media_Player v1.2.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
